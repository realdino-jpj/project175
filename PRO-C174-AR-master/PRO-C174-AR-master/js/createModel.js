AFRAME.registerComponent("createmodels", {
  init: async function() {
    // executing get models function
    var models = await this.getModels();

    // getting the keys for all the objects in the json list 
    var barcodes = Object.keys(models);
    // spliting the the data in barcodes var and executing createModel function
  ...
  // function fetching json lists of models 
  getModels: function() {
  ...
  // function for getting markers and creating barcode
