...
AFRAME.registerComponent("markerhandler",{
    ...
    var compounds = this.getCompounds()
        this.el.addEventListener("markerFound",() =>{
         ...
         // Getting the model name and barcode value and push the data in modelList.
           var modelName = this.getAttribute("model_name")
           var barcodeValue = this.getAttribute("barcode_value")
